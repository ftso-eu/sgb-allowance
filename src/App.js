...
function App() {
    return (
        <div>
            ...
            <br></br><center>
            <h3><a href="https://github.com/ftso-eu/sgb-allowance/blob/master/README.md" target="_blank">how it works? get more inf<img id="github" alt="GitHub" src="../images/github-o.png" width="15"></img></a></h3>
            <br></br>
