        ...
        return (
            <div>
                <div className="allowance">
                    ...
                    <div className="container">
                        <div className="centered"><a href={this.props.etherscanURL + this.props.tx.approved}>{this.truncateName(this.props.tx.approvedName) + "(" + this.props.tx.spenderName + ")"}</a></div>
                    </div>
