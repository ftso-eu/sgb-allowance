            ...
            <div>
                <div className="allowance">
                    <div className="container">
                        <div className="centered"><a href={this.props.etherscanURL + this.props.tx.contract}>{this.truncateName(this.props.tx.contractName)}</a>" on " + {this.props.tx.RouterName}</div>
                    </div>
