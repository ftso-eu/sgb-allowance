    ...
    render() {
		...
		<div id="bar">
		    ...
		    <h2><strong>&Xi;VMALLOWANC&Xi;</strong></h2>
                    <h6>Search and revoke allowances on Flare, Songbird, Coston1, Coston2, Polygon, Binance Smart Chain, Arbitrum, Optimistic, Ethereum, Ropsten, Rinkeby, Kovan, Fantom.</h6>
		    ...
		    <h5 id="counts"></h5>
                ...
                <h4 id="loading" hidden><br></br>Loading, please wait...</h4>
                <div id="revokeAll">
