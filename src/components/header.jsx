 ...
 async function onInit() {
	...
	var accountend = account.substring(account.length - 5);
        ...
        netname = "flare";
                ...
                else if (chain === "1449000") {
        netname = "xrpl evm test";
		}
		else if (chain === "114") {
        netname = "coston2";
		}
    ...
    render() {
		...
		<div id="bar">
		    ...
		    <h1><strong>&Xi;VMALLOWANC&Xi;</strong></h1>    
                    <h5>Show & Revoke allowances on: Flare, Songbird, Coston1, Coston2, Xrpl test EVM, XDC net, Avalanche, Polygon, Binance Chain, Arbitrum, Optimistic, Fantom, Ethereum, Ropsten, Rinkeby, Kovan.</h5>	    
