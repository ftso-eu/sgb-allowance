...
class header extends Component {
    ...
    render() {
		...
		<div id="bar">
		    ...
		    <h3><a href="https://github.com/ftso-eu/sgb-allowance/blob/master/README.md" target="_blank">Supported chains | inf<img id="github" alt="GitHub" src="../images/github-o.png" width="15"></img></a></h3>
                    <h4 id="addy"></h4>
		    <h5 id="totcounts"></h5>
		    <h5 id="counts"></h5>
		</div>
