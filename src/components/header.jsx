...
class header extends Component {
    ...
    render() {
		...
		<div id="bar">
		    ...
		    <h4><a href="https://github.com/ftso-eu/sgb-allowance/blob/master/README.md" target="_blank">more inf<img id="github" alt="GitHub" src="../images/github-o.png" width="13"></img></a></h3>
                    <h4 id="addy"></h4>
		    <h5 id="totcounts"></h5>
		    <h5 id="counts"></h5>
		</div>
